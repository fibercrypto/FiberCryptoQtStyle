...
#ifndef QQUICKFIBERCRYPTOSTYLE_P_H
#define QQUICKFIBERCRYPTOSTYLE_P_H
...
class QQuickFiberCryptoStyle : public QQuickAttachedObject
{
    Q_OBJECT
...
public:
    ...
    explicit QQuickFiberCryptoStyle(QObject *parent = nullptr);

    static QQuickFiberCryptoStyle *qmlAttachedProperties(QObject *object);
...
QML_DECLARE_TYPEINFO(QQuickFiberCryptoStyle, QML_HAS_ATTACHED_PROPERTIES)

#endif // QQUICKFIBERCRYPTOSTYLE_P_H
